...
MdbDraggableDirective.ɵfac = function MdbDraggableDirective_Factory(t) { return new (t || MdbDraggableDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(DOCUMENT)); };
MdbDraggableDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: MdbDraggableDirective, selectors: [["", "mdbDraggable", ""]], hostVars: 4, hostBindings: function MdbDraggableDirective_HostBindings(rf, ctx) { if (rf & 2) {
        ɵngcc0.ɵɵclassProp("mdb-draggable", ctx.movable)("mdb-dragging", ctx.dragging);
    } }, inputs: { disabled: "disabled", resetPosition: "resetPosition", snapSensitivity: "snapSensitivity", lockAxis: "lockAxis", autoScroll: "autoScroll", scrollSpeed: "scrollSpeed", scrollSensitivity: "scrollSensitivity", snapToGrid: "snapToGrid", gridSize: "gridSize", boundTo: "boundTo", handle: "handle" }, outputs: { dragStart: "dragStart", dragEnd: "dragEnd" } });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MdbDraggableDirective, [{
        type: Directive,
        args: [{
            ...
            type: HostBinding,
            args: ['class.mdb-draggable']
        }], dragging: [{
            type: HostBinding,
            args: ['class.mdb-dragging']
        }], boundTo: [{
            type: Input
        }], handle: [{
            type: Input
...
MdbDraggableModule.ɵfac = function MdbDraggableModule_Factory(t) { return new (t || MdbDraggableModule)(); };
MdbDraggableModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: MdbDraggableModule });
MdbDraggableModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MdbDraggableModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MdbDraggableModule, { declarations: [MdbDraggableDirective], exports: [MdbDraggableDirective] }); })();
