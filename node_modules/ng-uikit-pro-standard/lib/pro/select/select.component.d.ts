...
export declare class MdbSelectComponent implements OnInit, OnDestroy, AfterContentInit, ControlValueAccessor {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MdbSelectComponent, [null, null, null, null, null, { optional: true; self: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MdbSelectComponent, "mdb-select-2", never, { "allowClear": "allowClear"; "clearButtonTabindex": "clearButtonTabindex"; "disabled": "disabled"; "highlightFirst": "highlightFirst"; "label": "label"; "multiple": "multiple"; "notFoundMsg": "notFoundMsg"; "outline": "outline"; "tabindex": "tabindex"; "required": "required"; "ariaLabel": "aria-label"; "visibleOptions": "visibleOptions"; "dropdownHeight": "dropdownHeight"; "optionHeight": "optionHeight"; "value": "value"; "compareWith": "compareWith"; "dropdownClass": "dropdownClass"; "placeholder": "placeholder"; "ariaLabelledby": "aria-labelledby"; "sortComparator": "sortComparator"; }, { "valueChange": "valueChange"; "opened": "opened"; "closed": "closed"; "selected": "selected"; "deselected": "deselected"; "noOptionsFound": "noOptionsFound"; }, ["filter", "selectAllOption", "options", "optionGroups"], ["mdb-select-filter", "mdb-select-all-option", "mdb-select-option, mdb-option-group", "*"]>;
}
