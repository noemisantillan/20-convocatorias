...
export declare class MdbAutoCompleterComponent implements AfterContentInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MdbAutoCompleterComponent, "mdb-auto-completer", ["mdbAutoCompleter"], { "clearButton": "clearButton"; "clearButtonTabIndex": "clearButtonTabIndex"; "dropdownPosition": "dropdownPosition"; "visibleOptions": "visibleOptions"; "optionHeight": "optionHeight"; "dropdownHeight": "dropdownHeight"; "textNoResults": "textNoResults"; "appendToBody": "appendToBody"; "disabled": "disabled"; "displayValue": "displayValue"; }, { "select": "select"; "selected": "selected"; }, ["optionList", "mdbOptions"], ["*"]>;
}
