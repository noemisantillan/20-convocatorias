...
export declare class MdbTimePickerComponent implements OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MdbTimePickerComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MdbTimePickerComponent, "mdb-timepicker", ["mdbTimePicker"], { "autoClose": "autoClose"; "clearButton": "clearButton"; "closeButton": "closeButton"; "okButton": "okButton"; "rounding": "rounding"; "twelveHour": "twelveHour"; "max": "max"; "min": "min"; }, { "timeChange": "timeChange"; "cancel": "cancel"; "done": "done"; "show": "show"; }, never, never>;
}
