...
export declare class SelectAllOptionComponent extends OptionComponent implements OnInit {
    ...
    option: boolean;
    ngOnInit(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<SelectAllOptionComponent, [null, null, { optional: true; }, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<SelectAllOptionComponent, "mdb-select-all-option", never, {}, {}, never, ["*"]>;
}
